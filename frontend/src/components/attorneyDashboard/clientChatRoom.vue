...
<!--                            DASHBOARD STARTS HERE -->
             ...
             <div class="main-container">
                ...
                <div class="action-pane center-pane">
                    <p>All your cleint is here </p>
                    <li v-for="(clients, index) in cabinetClient" :key="index"> 
                       <ul v-for="(client, index) in clients.clientDetails" :key="index">
                           <li> <a @click="getChatWithAttorney(client._id,attorney._id)" href="#">{{client.fullName}}</a></li>
                       </ul>
                    </li>
                </div>
    ...
    export default ({
        ...
        methods: {
            ...
            getCabinetInChat: function(){
                http.get("workspaces/workspaceByCabinetId/"+this.$session.get("cabinetId"))
                    .then( response => {
                        this.cabinetClient = response.data.data
                    })
